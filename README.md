...
graph TD
    ...
    Client <--> |REST| Auth0
    Broker <-->|gRPC| Account["<b>Account</b><br>(Docker)"]
    ...
    Account -->|gRPC| PostgreSQL["<b>PostgreSQL</b>"]
...
2. `account`: A microservice responsible for CRUD operations on user information
